...
export default function ASCIIText({
  ...
  width,
  height,
}: ASCIITextProps & { width?: number; height?: number }) {
  ...
  return (
    <div
      ref={containerRef}
      className="ascii-text-container dark" // ativa dark mode se quiser
      style={{
        "--font-sans": pixelify.style.fontFamily, // define a variável CSS
